...
namespace AutomatedTellerMachine.Controllers
{
    ...
    public class CheckingAccountController : Controller
    {
        ...
        public ActionResult Details()
        {
            ...
            // var checkingAccount = new CheckingAccount{AccountNumber="0000032434324",Balance=500,FirstName="Michael",LastName="Sullivan"};
        ...
        public ActionResult Statement(int id)
        {
            ...
            Debug.WriteLine("objet checking account:"+ Newtonsoft.Json.JsonConvert.SerializeObject(CheckingAccount,Newtonsoft.Json.Formatting.Indented,new Newtonsoft.Json.JsonSerializerSettings { ReferenceLoopHandling = Newtonsoft.Json.ReferenceLoopHandling.Ignore}));
            return View(CheckingAccount.Transactions.ToList());
        }

        // GET: CheckingAccount/Details/id
